...
function setupMultiplayer() {
    ...
    const serverUrls = [
        ...
        'ws://localhost:3000',
        // Add your deployed server URL here (e.g., from Render, Railway)
        // 'wss://your-game-server.onrender.com',
    ];
...
const materials = {
    grass: new THREE.MeshStandardMaterial({ color: 0x88c070 }),
    dirt: new THREE.MeshStandardMaterial({ color: 0x785c40 }),
    stone: new THREE.MeshStandardMaterial({ color: 0x7f7f7f })
};
    ...
    for(let z = 0; z < WORLD_SIZE; z++) {
        ...
        for(let y = 0; y < height; y++) {
            ...
            if (y === height - 1) {
                ...
                material = materials.dirt;  // Next 3 layers are dirt
            } else {
